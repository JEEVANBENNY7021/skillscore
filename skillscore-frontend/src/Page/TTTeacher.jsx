...
function TTTeacher() {
  ...
  // Generate a shuffled timetable based on shuffled teacher data
  ...
  const handleShuffleClick = () => {
    generateShuffledTimetable(teacherData);
  };
  ...
  const handleSaveClick = async () => {
    ...
    try {
      ...
      Swal.fire({
        title: 'Success!',
        text: 'Timetable added successful!',
        icon: 'success',
        confirmButtonText: 'OK',
    });
    } catch (error) {
  ...
  return (
    <div style={styles.timetableContainer}>
      ...
      <button onClick={handleShuffleClick} style={styles.shuffleButton}>
        Shuffle Timetable
      </button>
